...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "UserProfile":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "UserProfile": %w`, err)
			}
			switch resolverName {
			...
			case "findUserProfileByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findUserProfileByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindUserProfileByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "UserProfile": %w`, err)
				}
...
func entityResolverNameForUserProfile(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
	...
	return "", fmt.Errorf("%w for UserProfile", ErrTypeNotFound)
}
