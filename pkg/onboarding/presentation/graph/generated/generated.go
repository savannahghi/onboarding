...
func (ec *executionContext) unmarshalInputFilterInput(ctx context.Context, obj interface{}) (firebasetools.FilterInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "filterBy":
			...
			data, err := ec.unmarshalOFilterParam2ᚕᚖgithubᚗcomᚋsavannahghiᚋfirebasetoolsᚐFilterParam(ctx, v)
			if err != nil {
				return it, err
			}
			it.FilterBy = data
...
func (ec *executionContext) unmarshalInputFilterParam(ctx context.Context, obj interface{}) (firebasetools.FilterParam, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "fieldType":
			...
			data, err := ec.unmarshalNFieldType2githubᚗcomᚋsavannahghiᚋenumutilsᚐFieldType(ctx, v)
			if err != nil {
				return it, err
			}
			it.FieldType = data
		case "comparisonOperation":
			...
			data, err := ec.unmarshalNOperation2githubᚗcomᚋsavannahghiᚋenumutilsᚐOperation(ctx, v)
			if err != nil {
				return it, err
			}
			it.ComparisonOperation = data
		case "fieldValue":
			var err error
...
func (ec *executionContext) unmarshalInputSortInput(ctx context.Context, obj interface{}) (firebasetools.SortInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "sortBy":
			...
			data, err := ec.unmarshalOSortParam2ᚕᚖgithubᚗcomᚋsavannahghiᚋfirebasetoolsᚐSortParam(ctx, v)
			if err != nil {
				return it, err
			}
			it.SortBy = data
...
func (ec *executionContext) unmarshalInputSortParam(ctx context.Context, obj interface{}) (firebasetools.SortParam, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "sortOrder":
			...
			data, err := ec.unmarshalNSortOrder2githubᚗcomᚋsavannahghiᚋenumutilsᚐSortOrder(ctx, v)
			if err != nil {
				return it, err
			}
			it.SortOrder = data
...
func (ec *executionContext) unmarshalInputUserProfileInput(ctx context.Context, obj interface{}) (dto.UserProfileInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "gender":
			...
			data, err := ec.unmarshalOGender2ᚖgithubᚗcomᚋsavannahghiᚋenumutilsᚐGender(ctx, v)
			if err != nil {
				return it, err
			}
			it.Gender = data
