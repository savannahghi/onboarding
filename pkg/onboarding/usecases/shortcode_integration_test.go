...
func TestSMSImpl_ProcessShortCodeSMS_integration(t *testing.T) {
	...
	_ = s.Engagement.NotifySupportTeam(ctx, *supportNotification)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := s.SMS.ProcessShortCodeSMS(tt.args.ctx, &tt.args.input)
