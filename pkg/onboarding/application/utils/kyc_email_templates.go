...
// SupportShortCodeNotificationEmail ...
const SupportShortCodeNotificationEmail = `
<!DOCTYPE html>
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
    xmlns:o="urn:schemas-microsoft-com:office:office">
                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 3em; text-align: left;">
                                        ...
                                        <p>Below are shortcode's SMS sender details:</p>
                                        <p style="margin: 0;">Title: <span
                                                style="color: #000000;">{{.SubjectTitle}}</span>
                                        </p>
                                        <p style="margin: 0;">Phone Number: <span
                                                style="color: #000000;">{{.PrimaryPhone}}</span>
                                        </p>
