...
// StageCRMPayload ...
func (f *FakeOnboardingRepository) StageCRMPayload(
	ctx context.Context,
...
func (f *FakeOnboardingRepository) UpdateStageCRMPayload(
	ctx context.Context,
	phoneNumber string,
...
// GetStageCRMPayload ...
func (f *FakeOnboardingRepository) GetStageCRMPayload(
	ctx context.Context,
	phoneNumber string,
) (*dto.ContactLeadInput, error) {
